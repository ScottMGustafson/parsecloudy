...
def plot_it(ax,element,coords):
    ...
    ax.text(coords[1][0],coords[1][1],element+'II')
    ax.text(coords[2][0],coords[2][1],element+'III')
    ax.text(coords[3][0],coords[3][1],element+'IV')
    ax.text(coords[4][0],coords[4][1],element+'V')
...
plot_it(Si_ax,'Si',[[-2.48,0.],[-2.48,0.03],[-2.48,0.6],[-2.48,0.11],[-2.48,0.19]])
